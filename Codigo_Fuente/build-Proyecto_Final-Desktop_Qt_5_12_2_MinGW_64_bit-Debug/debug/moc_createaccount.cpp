...
#include "../../Proyecto_Final/createaccount.h"
...
QT_MOC_LITERAL(1, 14, 18), // "closeWindowAccount"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 20) // "on_PB_Create_clicked"

    },
    "createAccount\0closeWindowAccount\0\0"
...
void createAccount::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->closeWindowAccount(); break;
        ...
        {
            using _t = void (createAccount::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&createAccount::closeWindowAccount)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void createAccount::closeWindowAccount()
{
